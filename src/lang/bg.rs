...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Позволени са само знаци a-z, A-Z, 0-9, @, . (точка), - (тире) и _ (долна черта). Първият знак трябва да е буква a-z или A-Z. Символът @ е задължителен; след него поне 3 букви или цифри. Дължина между 8 и 32."),
        ("Website", "Уебсайт"),
        ("About", "За програмата"),

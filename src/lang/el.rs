...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Επιτρέπονται μόνο οι χαρακτήρες a-z, A-Z, 0-9, @, . (τελεία), - (παύλα) και _ (κάτω παύλα). Ο πρώτος χαρακτήρας πρέπει να είναι γράμμα a-z ή A-Z. Το @ είναι υποχρεωτικό· μετά από αυτό τουλάχιστον 3 γράμματα ή ψηφία. Μήκος μεταξύ 8 και 32."),
        ("Website", "Ιστότοπος"),
        ("About", "Σχετικά"),

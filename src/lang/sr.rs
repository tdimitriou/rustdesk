...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allowed characters", ""),
        ("id_change_tip", "Dozvoljeni su samo znakovi a-z, A-Z, 0-9, @, . (tačka), - (crtica) i _ (donja crta). Prvi znak mora biti slovo a-z ili A-Z. Znak @ je obavezan; iza njega najmanje 3 slova ili cifre. Dužina od 8 do 32."),
        ("Website", "Web sajt"),
        ("About", "O programu"),
        ("Slogan_tip", ""),
        ("Privacy Statement", ""),

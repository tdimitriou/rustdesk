...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Povoleny jsou pouze znaky a-z, A-Z, 0-9, @, . (tečka), - (pomlčka) a _ (podtržítko). První znak musí být písmeno a-z nebo A-Z. Znak @ je povinný; za ním nejméně 3 písmena nebo číslice. Délka 8 až 32 znaků."),

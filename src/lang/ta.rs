...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "a-z, A-Z, 0-9, @, . (புள்ளி), - (கோடு), _ (அடிக்கோடு) எழுத்துக்கள் மட்டுமே அனுமதி. முதல் எழுத்து a-z அல்லது A-Z எழுத்தாக இருக்க வேண்டும். @ கட்டாயம்; அதன் பின் குறைந்தபட்சம் 3 எழுத்துக்கள் அல்லது எண்கள். நீளம் 8 முதல் 32 வரை."),
        ("Website", "இணையதளம்"),
        ("About", "பற்றி"),

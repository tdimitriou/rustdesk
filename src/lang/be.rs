...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Дапушчальныя толькі сімвалы a-z, A-Z, 0-9, @, . (кропка), - (дэфіс) і _ (падкрэсліванне). Першы сімвал павінен быць літарай a-z або A-Z. Сімвал @ абавязковы; пасля яго мінімум 3 літары або лічбы. Даўжыня ад 8 да 32."),
        ("Website", "Сайт"),
        ("About", "Пра праграму"),

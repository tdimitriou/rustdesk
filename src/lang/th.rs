...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "อนุญาตเฉพาะอักขระ a-z, A-Z, 0-9, @, . (จุด), - (ขีดกลาง) และ _ (ขีดล่าง) เท่านั้น อักขระแรกต้องเป็นตัวอักษร a-z หรือ A-Z ต้องมี @ และหลังจากนั้นต้องมีตัวอักษรหรือตัวเลขอย่างน้อย 3 ตัว ความยาวระหว่าง 8 ถึง 32"),
        ("Website", "เว็บไซต์"),
        ("About", "เกี่ยวกับ"),

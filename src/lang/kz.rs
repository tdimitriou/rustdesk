...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allowed characters", ""),
        ("id_change_tip", "Тек a-z, A-Z, 0-9, @, . (нүкте), - (сызық) және _ (астынғы сызық) таңбаларына рұқсат етіледі. Бірінші таңба a-z немесе A-Z әрпі болуы керек. @ міндетті; одан кейін кемінде 3 әріп немесе сан. Ұзындығы 8 мен 32 арасында."),
        ("Website", "Web-сайт"),
        ("About", "Туралы"),
        ("Slogan_tip", ""),
        ("Privacy Statement", ""),

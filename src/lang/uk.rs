...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Дозволені лише символи a-z, A-Z, 0-9, @, . (крапка), - (дефіс) і _ (підкреслення). Першим має бути літера a-z або A-Z. Символ @ обов'язковий; після нього щонайменше 3 літери або цифри. Довжина від 8 до 32."),
        ("Website", "Веб-сайт"),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Solo se permiten los caracteres a-z, A-Z, 0-9, @, . (punto), - (guión) y _ (guion bajo). El primer carácter debe ser una letra a-z o A-Z. El símbolo @ es obligatorio; después al menos 3 letras o números. Longitud entre 8 y 32."),
        ("Website", "Sitio web"),
        ("About", "Acerca de"),

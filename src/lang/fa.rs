...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "فقط نویسه‌های a-z، A-Z، 0-9، @، . (نقطه)، - (خط تیره) و _ (زیرخط) مجازند. نویسهٔ اول باید حرف a-z یا A-Z باشد. @ الزامی است و پس از آن حداقل ۳ حرف یا رقم لازم است. طول بین 8 و 32."),
        ("Website", "وب سایت"),
        ("About", "درباره"),

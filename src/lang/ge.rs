...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "დაშვებულია მხოლოდ სიმბოლოები a-z, A-Z, 0-9, @, . (წერტილი), - (ტირე) და _ (ქვედა ტირე). პირველი სიმბოლო უნდა იყოს ასო a-z ან A-Z. @ სავალდებულოა; მის შემდეგ მინიმუმ 3 ასო ან ციფრი. სიგრძე 8-დან 32-მდე."),
        ("Website", "ვებგვერდი"),

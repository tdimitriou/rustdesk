...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Допускаются только символы a-z, A-Z, 0-9, @, . (точка), - (дефис) и _ (подчёркивание). Первым должен быть символ буквы a-z или A-Z. Символ @ обязателен; после него не менее 3 букв или цифр. Длина от 8 до 32."),
        ("Website", "Сайт"),
        ("About", "О приложении"),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Dovoljeni so le znaki a-z, A-Z, 0-9, @, . (pika), - (pomišljaj) in _ (podčrtaj). Prvi znak mora biti črka a-z ali A-Z. Znak @ je obvezen; za njim vsaj 3 črke ali številke. Dolžina od 8 do 32."),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("id_change_tip", "Povolené sú len znaky a-z, A-Z, 0-9, @, . (bodka), - (pomlčka) a _ (podčiarkovník). Prvý znak musí byť písmeno a-z alebo A-Z. Znak @ je povinný; za ním aspoň 3 písmená alebo číslice. Dĺžka medzi 8 a 32."),
